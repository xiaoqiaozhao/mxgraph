...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	var w = 50;
	var h = 50;
	var s = 'shape=mxgraph.bpmn.shape;html=1;rounded=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;align=center;perimeter=rhombusPerimeter;background=gateway;outlineConnect=0;fillColor=rgb(220,240,255);strokeColor=rgb(42,161,252);';
	var ss = 'html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;align=center;perimeter=ellipsePerimeter;outlineConnect=0;fillColor=rgb(42,161,252);strokeColor=rgb(220,240,255);strokeWidth=2;color=#ffffff;';
	var es = 'shape=mxgraph.bpmn.shape;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;align=center;'+
	'perimeter=ellipsePerimeter;outlineConnect=0;fillColor=rgb(42,161,252);strokeColor=rgb(220,240,255);strokeWidth=2;fontSize=30;fontColor=rgb(42, 161, 252);';
	var edt = 'bpmn business process model event ';
	var dt = 'bpmn business process model gateway ';
	var field = new mxCell('+ field: type', new mxGeometry(0, 0, 100, 120), 'text;strokeColor=none;fillColor=rgb(220,240,255);align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;
	var fns =
	[
		// 开始
		// 开始
		this.createVertexTemplateEntry('shape=mytriangle;whiteSpace=wrap;html=1;rounded=1;fillColor=rgb(220,240,255);strokeColor=rgb(42,161,252);verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;align=center;symbol=general;', 80, 80, '', '开始', null, null, 'bpmn subprocess sub process sub-process marker'),
		// this.addEntry('shape group container', function()
		// {
		//     var cell = new mxCell('', new mxGeometry(0, 0, 60, 60),
		// 		'html=1;whiteSpace=wrap;container=1;recursiveResize=0;collapsible=0;rounded=1;fillColor=rgb(220,240,255);strokeColor=rgb(42,161,252);');
		//     cell.vertex = true;
		    
		// 	var symbol = new mxCell('', new mxGeometry(22, 20, 20, 22), 'triangle;html=1;whiteSpace=wrap;fillColor=rgb(42,161,252);strokeColor=rgb(42,161,252);');
		// 	symbol.vertex = true;
		// 	cell.insert(symbol);
	    	
    // 		return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '开始');
		// }),
		// 结束
		this.createVertexTemplateEntry('shape=image;image=' + 'static/js/plugins/mxgraph/jscolor/end.png', 52, 61, '', '', false, null, ''),
		// 任务处理人
		this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'user_task').join(' '), function()
		 {
			 var cell = new mxCell('User Task', new mxGeometry(0, 0, 100, 60), 'html=1;whiteSpace=wrap;rounded=1;fillColor=rgb(220,240,255);strokeColor=rgb(42,161,252);fontColor=rgb(42,161,252);');
			 cell.vertex = true;
			 var cell1 = new mxCell('', new mxGeometry(0, 0, 14, 14), 'shape=image;html=1;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + 'static/js/plugins/mxgraph/jscolor/sub process.png', 52, 61,'', 'Image (Fixed Aspect)', false, null, 'fixed image icon symbol');
			 cell1.vertex = true;
			 cell1.geometry.relative = true;
			 cell1.geometry.offset = new mxPoint(7, 22);
			 cell.insert(cell1);
			 return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, 'User Task');
		 }),
		//  子流程（sub-process）
		this.createVertexTemplateEntry('swimlane;strokeColor=rgb(42,161,252);fontColor=rgb(42,161,252);', 200, 200, '子流程', '子流程', null, null, 'container swimlane lane pool group'),
    ...
    this.createVertexTemplateEntry(s + 'outline=none;symbol=parallelGw;', w, h, '', '并行网关', null, null, dt + 'parallel'),
		// this.createVertexTemplateEntry('shape=sortShape1;perimeter=rhombusPerimeter;whiteSpace=wrap;html=1;rounded=1;fillColor=rgb(220,240,255);strokeColor=rgb(42,161,252);', 80, 80, '', '排他网关', null, null, '排他网关'),
		// this.createVertexTemplateEntry('shape=closeLines;perimeter=rhombusPerimeter;whiteSpace=wrap;html=1;rounded=1;fillColor=rgb(220,240,255);strokeColor=rgb(42,161,252);', 80, 80, '', '并行网关', null, null, '并行网关'),
		
		// this.createVertexTemplateEntry('shape=image;image=' + 'static/js/plugins/mxgraph/jscolor/start.png', 52, 61, '', '', false, null, ''),
		// this.createVertexTemplateEntry('shape=image;image=' + 'static/js/plugins/mxgraph/jscolor/open.png', 30, 40, '', '排他网关', false, null, ''),
		// this.createVertexTemplateEntry('shape=image;image=' + 'static/js/plugins/mxgraph/jscolor/close.png', 30, 40, '', '并行网关', false, null, ''),
		// 排他网关
		// this.addEntry('', function()
		// {
		// 	var cell = new mxCell('', new mxGeometry(0, 0, 30, 80), 'shape=image;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + 'static/js/plugins/mxgraph/jscolor/open.png', 52, 61, '', '', false, null, '');
		// 	cell.vertex = true;
		// 	var cell1 = new mxCell('', new mxGeometry(30, 0, 85, 85), 'shape=image;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + 'static/js/plugins/mxgraph/jscolor/open.jpg', 52, 61, '', '', false, null, '');
		// 	cell1.vertex = true;
		// 	cell.insert(cell1);
		// 	return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '排他网关');
		// }),
		// 并行网关
		// this.addEntry('', function()
		// {
		// 	var cell = new mxCell('', new mxGeometry(0, 0, 60, 60), 'shape=image;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + 'static/js/plugins/mxgraph/jscolor/close.jpg', 52, 61, '', '', false, null, '');
		// 	cell.vertex = true;
		// 	var cell1 = new mxCell('', new mxGeometry(60, -10, 30, 80), 'shape=image;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + 'static/js/plugins/mxgraph/jscolor/close.png', 52, 61, '', '', false, null, '');
		// 	cell1.vertex = true;
		// 	cell.insert(cell1);
		// 	return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, '并行网关');
		// }),
		
		
		// this.createVertexTemplateEntry(s + 'outline=none;symbol=exclusiveGw;', 50, 50, '', '排他网关', null, null, dt + 'exclusive'),
		// this.createVertexTemplateEntry(s + 'outline=none;symbol=parallelGw;', 50, 50, '', '并行网关', null, null, dt + 'parallel'),
		// this.createVertexTemplateEntry('ellipse;html=1;shape=endState;fillColor=rgb(42,161,252);strokeColor=red;strokeWidth=3;image=' + this.gearImage, 50, 50, 'END', 'END', false, null, 'uml activity state end'),
		// this.createVertexTemplateEntry('ellipse;html=1;shape=endState;fillColor=rgb(42,161,252);strokeColor=rgb(248,252,255);strokeWidth=10;', 30, 30, '', 'End', null, null, 'uml activity state end'),
		// this.createVertexTemplateEntry('shape=image;html=1;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;imageAspect=1;aspect=fixed;image=' + this.gearImage, 52, 61, '', 'Image (Fixed Aspect)', false, null, 'fixed image icon symbol'),
		// this.createVertexTemplateEntry('ellipse;shape=doubleEllipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Double Circle', null, null, 'double circle'),
	...
	this.addPaletteFunctions('bpmn', '组件', true, fns);
};
